...
[![Portfolio](https://img.shields.io/badge/ENTER_THE_DOMAIN-090909?style=for-the-badge&logo=firefox&logoColor=ff3344)](${config.website})
[![Email](https://img.shields.io/badge/OPEN_A_CHANNEL-090909?style=for-the-badge&logo=gmail&logoColor=ff3344)](mailto:${config.email})
...
> **${config.role}** from **${config.location}**  
> ${config.tagline}
...
<div align="center">
  <img src="./assets/generated/ascii-orochi.svg" width="100%" alt="ASCII art generated directly from the Orochi dragon banner" />
</div>
